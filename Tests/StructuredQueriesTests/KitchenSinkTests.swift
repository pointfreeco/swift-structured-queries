  ...
  @Suite struct KitchenSinkTests {
    ...
    @Test func jsonGroupArray() {
      assertQuery(
        ...
        """
        SELECT "kitchens"."id", json_group_array(CASE WHEN ("kitchenSinks"."rowid") IS NOT (NULL) THEN json_object('id', "kitchenSinks"."id", 'kitchenID', "kitchenSinks"."kitchenID", 'bool', json(CASE "kitchenSinks"."bool" WHEN 0 THEN 'false' WHEN 1 THEN 'true' END), 'optionalBool', json(CASE "kitchenSinks"."optionalBool" WHEN 0 THEN 'false' WHEN 1 THEN 'true' END), 'string', "kitchenSinks"."string", 'optionalString', "kitchenSinks"."optionalString", 'int', "kitchenSinks"."int", 'optionalInt', "kitchenSinks"."optionalInt", 'double', "kitchenSinks"."double", 'optionalDouble', "kitchenSinks"."optionalDouble", 'rawRepresentable', "kitchenSinks"."rawRepresentable", 'optionalRawRepresentable', "kitchenSinks"."optionalRawRepresentable", 'iso8601Date', "kitchenSinks"."iso8601Date", 'optionalISO8601Date', "kitchenSinks"."optionalISO8601Date", 'unixTimeDate', datetime("kitchenSinks"."unixTimeDate", 'unixepoch'), 'optionalUnixTimeDate', datetime("kitchenSinks"."optionalUnixTimeDate", 'unixepoch'), 'julianDayDate', datetime("kitchenSinks"."julianDayDate", 'julianday', 'subsec'), 'optionalJulianDayDate', datetime("kitchenSinks"."optionalJulianDayDate", 'julianday', 'subsec'), 'jsonArray', json("kitchenSinks"."jsonArray"), 'optionalJSONArray', json("kitchenSinks"."optionalJSONArray"), 'jsonArrayOfDates', json("kitchenSinks"."jsonArrayOfDates")) END) FILTER (WHERE ("kitchenSinks"."rowid") IS NOT (NULL))
        FROM "kitchens"
